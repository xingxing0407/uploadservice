...
namespace xmlwriterservice
{
    public partial class Service1 : ServiceBase
    {
        ...
        private void writelog(string msg)
        {
            ...
            using (System.IO.StreamWriter sw = new System.IO.StreamWriter(strAssemblyDirPath+"/xmllog.txt", true))
            {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            myTimer.Interval = 10*60*1000; //设置计时器事件间隔执行时间
                    ...
                    if (intneednum > 0)
                    {
                        ...
                        try
                        {
                            if (mySqlDataReader.Read())
                            {
                                ...
                                //    continue;
                                //}
                                dunc = ConfigurationManager.AppSettings["dunc"];
